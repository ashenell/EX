...
public class NumberStringTests {
    ...
    @Test
    public void findsStreaksT() {
        List<Character> characters = List.of('a', 'b', 'b');
        List<List<Character>> steakList = NumberStringTests.getStreakList(characters.toString());


        System.out.println(steakList);
    ...
    @Test
    public void sortNumberGroups1() {
        //NumberString g1 = new NumberString("115");
        //NumberString g2 = new NumberString("1134");
        NumberString g1 = new NumberString("12232");
        NumberString g2 = new NumberString("1133");
    ...
    private static List<List<Character>> getStreakList(String input) {
